...
for epoch in range(1, epochs+1):
    for batch_index, (questions_batch, answers_batch) in enumerate(split_into_batches(training_questions, training_answers, batch_size)):
        ...
        if batch_index % batch_index_check_validation_loss == 0 and batch_index > 0:
            ...
            starting_time = time.time()
            for batch_index_validation, (questions_batch, answers_batch) in enumerate(split_into_batches(validation_questions, validation_answers, batch_size)):
                starting_time = time.time()
